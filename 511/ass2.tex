...
%% {\it Describe what progress and control metrics you will use to report progress across your teams, to
...
%% {\it One key risk is that the scope of the work may be larger than originally anticipated.  Briefly
...
%% {\it For each project risk, what do you plan to do to mitigate the risk?  For example, what if your
